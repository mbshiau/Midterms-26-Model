...
# Confirmed by hand (see conversation) to publish a single clean
# per-district summary table in the shape _parse_district_results_table
# understands. Every other state either lacks such a table, or enacted new
# 2026 district lines (see fetch_redistricting_changes) and is excluded
# regardless of table shape, since 2024's results wouldn't correspond to
# the current district registry.
ELIGIBLE_STATES = ["Georgia", "Michigan", "Minnesota", "New Mexico", "Connecticut"]
